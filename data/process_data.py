"""This module, loads and cleans the data of message.csv and categories.csv to a db."""
#Code is cleaned with: autopep8 --in-place --aggressive -- process_data.py
#Code is improved with pylin: pylin process_data.py
